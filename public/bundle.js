...
module.exports = {
  ...
  extend: function(target, source) {
    ...
    for (var prop in source) {
      // Go recursively
      if (this$1.isObject(source[prop])) {
        target[prop] = this$1.extend(target[prop], source[prop])
      } else {
...
, ControlIcons = __webpack_require__(3)
, Utils = __webpack_require__(1)
, SvgUtils = __webpack_require__(0)
, ShadowViewport = __webpack_require__(4)
...
SvgPanZoom.prototype.setupHandlers = function() {
  ...
  if (this.options.customEventsHandler != null) { // jshint ignore:line
    ...
    if (haltEventListeners && haltEventListeners.length) {
      for (var i = haltEventListeners.length - 1; i >= 0; i--) {
        if (this$1.eventListeners.hasOwnProperty(haltEventListeners[i])) {
          delete this$1.eventListeners[haltEventListeners[i]]
        }
      }
    }
  }
  ...
  // Bind eventListeners
  for (var event in this$1.eventListeners) {
    // Attach event to eventsListenerElement or SVG if not available
    (this$1.options.eventsListenerElement || this$1.svg)
      .addEventListener(event, this$1.eventListeners[event], false)
  }
...
SvgPanZoom.prototype.destroy = function() {
  ...
  for (var event in this$1.eventListeners) {
    (this$1.options.eventsListenerElement || this$1.svg)
      .removeEventListener(event, this$1.eventListeners[event], false)
  }
...
var svgPanZoom = __webpack_require__(2)
